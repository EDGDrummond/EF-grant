...
bench 'circom ../2/iszero2.circom --r1cs --wasm --json'
...
bench 'snarkjs groth16 setup ../iszero2.r1cs ../../pot/pot20_final.ptau iszero2.zkey
...
bench 'snarkjs groth16 prove iszero2-1.zkey witness.wtns proof.json public.json'
