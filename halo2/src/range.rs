use crate::{AssignedValue, MainGate, MainGateConfig, MainGateInstructions, Term};
use halo2wrong::halo2::arithmetic::FieldExt;
use halo2wrong::halo2::circuit::{Chip, Layouter, Value};
use halo2wrong::halo2::plonk::{Advice, Column, Expression, Fixed};
use halo2wrong::halo2::plonk::{ConstraintSystem, Error};
use halo2wrong::halo2::plonk::{Selector, TableColumn};
...
mod tests {
    ...
    use crate::{MainGate, MainGateInstructions, Term};
